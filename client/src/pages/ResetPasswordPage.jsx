...
function ResetPasswordPage() {
  ...
  const { resetPassword, error, isLoading, message } = useStore();
  ...
  return (
    ...
    >
      <div className="p-8">
        <h2 className="text-3xl font-bol mb-6 text-center bg-linear-to-r from-green-400 to-emerald-500 text-transparent bg-clip-text">
          Reset Password
        </h2>
